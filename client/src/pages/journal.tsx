                  ...
                  <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div className="flex justify-between items-center">
                        {createJournalMutation.data?.sentiment && (
                          <div className="text-sm">
                            Sentiment: <span className={cn(
                              "font-medium",
                              createJournalMutation.data.sentiment.rating >= 4 ? "text-green-600" :
                              createJournalMutation.data.sentiment.rating >= 3 ? "text-green-500" :
                              createJournalMutation.data.sentiment.rating > 2 ? "text-gray-600" :
                              createJournalMutation.data.sentiment.rating > 1 ? "text-orange-600" :
                              "text-red-600"
                            )}>
                              {getSentimentText(createJournalMutation.data.sentiment as Sentiment)}
                            </span>
                          </div>
                        )}
                            ...
                            <div className="flex justify-between items-center">
                              <div className="flex items-center space-x-1">
                                ...
                                <span className="text-sm text-gray-700 font-medium">
                                  {format(new Date(journal.date), 'MMMM d, yyyy • h:mm a')}
                                </span>
                              </div>
